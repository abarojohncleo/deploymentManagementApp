...
const Login = () => {
  ...
  return (
    <div className='bg-primaryBlue-900'>
      <div className='container mx-auto flex h-screen '>
        <div className="w-full max-w-xs mx-auto my-20">
        <form className="bg-white-900 shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full">
          ...
          <div className="flex items-center justify-center">
            <button onClick={submit} className="bg-primaryBlue-900 hover:bg-primaryBlue-600 hover:bg-secondary border-white w-96 text-white-900 bg-primary w-auto font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
              Sign In
            </button>
          </div>
        </form>
        <p className="text-center text-gray-500 text-xs text-white-900">
