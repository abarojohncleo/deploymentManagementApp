...
const DashboardMonitoringIcon = ({color="#000", width="32px", height="auto", showTooltip=false, tooltipText="", tooltipPlacement="bottom" }) => {
    return (
...
export default DashboardMonitoringIcon;